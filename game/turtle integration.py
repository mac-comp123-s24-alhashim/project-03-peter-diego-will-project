...
def is_number(ask):
    while ask != "1" and ask != "2" and ask != "3" and ask != "4" and ask != "5" and ask != "6" and ask != "7" and ask != "8" and ask != "9":
...
tiePic = Picture("Screenshot 2024-05-04 at 12.10.27 PM.png")

def loss_picture(lossPic):
    lossPic.show()

def tie_picture(tiePic):
    tiePic.show()
